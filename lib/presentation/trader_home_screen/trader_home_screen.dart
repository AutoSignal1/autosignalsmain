import '../trader_home_screen/widgets/trader_home_item_widget.dart';
...
class TraderHomeScreen extends GetWidget<TraderHomeController> {
  @override
                    ...
                    children: [
                      Obx(
                        () => ListView.separated(
                          ...
                          itemCount: controller.traderHomeModelObj.value
                              .traderHomeItemList.length,
                          itemBuilder: (context, index) {
                            TraderHomeItemModel model = controller
                                .traderHomeModelObj
                                .value
                                .traderHomeItemList[index];
                            return TraderHomeItemWidget(
                              model,
                            );
                          },
                        ),
                              ...
                              child: Column(
                                ...
                                children: [
                                  Text(
                                    ...
                                    overflow: TextOverflow.ellipsis,
                                    textAlign: TextAlign.left,
                                    style: AppStyle.txtInterMedium12Gray500,
                                  ),
                                  Padding(
                                    padding: getPadding(
                                      top: 8,
                                    ...
                                    child: Text(
                                      ...
                                      overflow: TextOverflow.ellipsis,
                                      textAlign: TextAlign.left,
                                      style: AppStyle.txtInterMedium15Gray800,
                                    ),
                                  ),
                                ],
                              ),
                                ...
                                children: [
                                  ...
                                  Padding(
                                    ...
                                    child: Text(
                                      ...
                                      textAlign: TextAlign.left,
                                      style: AppStyle
                                          .txtInterMedium15Deeporange3001,
                                    ),
                                  ),
                                ],
                              ),
