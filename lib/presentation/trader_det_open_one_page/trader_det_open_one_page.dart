import 'controller/trader_det_open_one_controller.dart';
import 'models/trader_det_open_one_model.dart';
...
class TraderDetOpenOnePage extends StatelessWidget {
  TraderDetOpenOneController controller =
      Get.put(TraderDetOpenOneController(TraderDetOpenOneModel().obs));
