...
class SignalsPageItemWidget extends StatelessWidget {
  SignalsPageItemWidget(this.signalsPageItemModelObj);

  SignalsPageItemModel signalsPageItemModelObj;

  var controller = Get.find<SignalsController>();
            ...
            Padding(
              ...
              child: Row(
                children: [
                  Obx(
                    () => Text(
                      signalsPageItemModelObj.priceTxt.value,
                      overflow: TextOverflow.ellipsis,
                      textAlign: TextAlign.left,
